...
import { getDailySummary, getCheckInRange } from './sparkyfitness-client.js';
...
// state.customEx only covers exercises you've created yourself — openGym's
// built-in library (the bulk of exercise IDs in practice) isn't exposed by
// the API at all, so an id with no match here isn't a bug, it's a gap a
// static id->name mapping has to fill on the Claude side.
