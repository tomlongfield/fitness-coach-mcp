...
// fire 90 concurrent requests at once.
const ACTIVITY_FETCH_CONCURRENCY = 10;
...
async function fetchActivitySessions(days) {
  ...
  const results = await mapWithConcurrency(dates, ACTIVITY_FETCH_CONCURRENCY, getExerciseEntriesByDate);
  return results
    .flat()
