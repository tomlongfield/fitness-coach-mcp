...
import { getDailySummary, getCheckInRange, getSleepAnalytics, getCustomMeasurementRange } from './sparkyfitness-client.js';
...
const VITALS_CATEGORIES = [
  ...
  ['apple_exercise_time', 'exerciseTimeMin', (v) => Math.round(v / 60)],
  ['apple_stand_time', 'standTimeMin', (v) => Math.round(v / 60)],
